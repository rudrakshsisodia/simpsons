...
// BarGraphColored renders a vertical bar graph using the specified hex color.
func BarGraphColored(data []int, width, height int, color string) string {
	if len(data) == 0 {
		return ""
	}
